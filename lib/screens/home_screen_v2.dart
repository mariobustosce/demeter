...
class _HomeScreenV2State extends State<HomeScreenV2> {
  ...
  late Future<String?> _svgMapFuture;
  ...
  void initState() {
    ...
    _svgMapFuture = Future.value(null);
  ...
  void _updateSkyData({bool initial = false}) {
    ...
    setState(() {
      _svgMapFuture = _skyService.getMapSvgMobile(lat: lat, lng: lon, date: dt);
                  ...
                  children: [
                    ...
                    FutureBuilder<Map<String, dynamic>>(
                      ...
                      builder: (context, snapshot) {
                        ...
                        final physics =
                            snapshot.data!['physics'] as Map<String, dynamic>?;
                        final astro =
                        ...
                        final daylightSeconds =
                            hasPhysics &&
                                ...
                                (daily['daylight_duration'] as List).isNotEmpty
                        ...
                        bool hasMoon = visiblePlanetsList.any(
                          (r) =>
                              r['cells'][0]['name'].toString().toLowerCase() ==
                                  'moon' ||
                              r['cells'][0]['name'].toString().toLowerCase() ==
                                  'luna',
                        );
                                ...
                                Container(
                                  ...
                                  child: Column(
                                    children: visiblePlanetsList.map((
                                      ...
                                      final symbol = symbolMap[rawName] ?? '✨';
                                  ...
                                  Expanded(
                                    child: Column(
                                      ...
                                      children: [
                                        ...
                                        ...(astro['houses'] as Map).entries.map(
                                          (e) => Text(
                    ...
                    Positioned.fill(
                      child: FutureBuilder<String?>(
                        ...
                        builder: (context, snapshot) {
                          ...
                          // Muestra el SVG a pantalla completa
                          return SvgPicture.string(
                            snapshot.data!,
                            fit: BoxFit.cover, // Ocupa todo el espacio de la pantalla sin márgenes
                            width: double.infinity,
